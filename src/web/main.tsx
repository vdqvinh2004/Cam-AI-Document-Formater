...
function WebApp() {
  ...
  const saveKey = () => {
    if (!key.trim()) return;
    keyStore.setKey(key.trim()); setKey(''); setConfigured(true); setMessage('Your key is stored in this browser origin.');
  };
